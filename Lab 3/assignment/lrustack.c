 ...
 */
 ...
 lru_stack_t* init_lru_stack(int size) {
     ...
     ////////////////////////////////////////////////////////////////////
     stack -> indicies = (int *)malloc(size * sizeof(int)); // array to track block indicies
     // init all inicies as LRU
 ...
 int lru_stack_get_lru(lru_stack_t* stack) {
     ...
     ////////////////////////////////////////////////////////////////////
     for (int i = 0; i < stack->size; i++) {
         if (stack->indicies[i] == (stack->size - 1)) {
             return i;
         }
     }
     ////////////////////////////////////////////////////////////////////
 ...
 void lru_stack_set_mru(lru_stack_t* stack, int n) {
     ...
     ////////////////////////////////////////////////////////////////////
     for(int i = 0; i < stack->size; i++) {
         if (stack->indicies[i] < stack->indicies[n]) {
             stack->indicies[i]++;
         }
     }
     stack->indicies[n] = 0;
